...
{
    private static byte[] Serialize(BaseGameNetworkPacket packet)
    {
    ...
    {
        var m = new MobileEntity
        {
            Id = new Serial(0x40A), BodyId = 0x190, Location = new Point3D(100, 200, 5), Direction = DirectionType.South,
            SkinHue = (Hue)0x83EA, Notoriety = NotorietyType.Innocent
        };
    ...
    public void ObjectInformation_Is26Bytes_WithGraphicAndLocation()
    {
        ...
        {
            Id = new Serial(0x40000001), ItemId = 0x0EED, Amount = 7, Location = new Point3D(123, 456, -3), Hue = (Hue)0x0021
        };
    ...
    public void MobileIncoming_StartsWithOpcodeAndLength_AndCarriesSerial()
    {
        var m = new MobileEntity
        {
            Id = new Serial(0x40B), BodyId = 0x190, Location = new Point3D(10, 20, 0), Direction = DirectionType.North,
            SkinHue = (Hue)0, Notoriety = NotorietyType.Innocent
        };
    ...
    public void MobileIncoming_WithEquippedItem_IsLongerThanBareBody()
    {
        var m = new MobileEntity
        {
            Id = new Serial(0x40C), BodyId = 0x190, Location = new Point3D(10, 20, 0), Direction = DirectionType.North,
            SkinHue = (Hue)0, Notoriety = NotorietyType.Innocent
        };
    ...
    public void MobileIncoming_HuedItem_SetsHueBit_AndWritesHue()
    {
        var m = new MobileEntity
        {
            Id = new Serial(0x40D), BodyId = 0x190, Location = new Point3D(10, 20, 0), Direction = DirectionType.North,
            SkinHue = (Hue)0, Notoriety = NotorietyType.Innocent
        };
    ...
    public void MobileIncoming_UnhuedItem_OmitsHue()
    {
        var m = new MobileEntity
        {
            Id = new Serial(0x40E), BodyId = 0x190, Location = new Point3D(10, 20, 0), Direction = DirectionType.North,
            SkinHue = (Hue)0, Notoriety = NotorietyType.Innocent
        };
