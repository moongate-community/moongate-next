...
namespace Moongate.Tests.Network.Framing;
...
public class NetFramerIntegrationTests
{
    ...
    public async Task ReceiveLoop_WithFramer_EmitsOneEventPerCompleteFrame()
    {
        ...
        await using var server = new MoongateTCPServer(new IPEndPoint(IPAddress.Loopback, 0), framer);
    ...
    public async Task ReceiveLoop_WithoutFramer_EmitsRawChunks()
    {
        ...
        MoongateTCPDataReceivedEventArgs? captured = null;
