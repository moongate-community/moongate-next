...
public sealed class JobServiceTests
{
    private static TimerWheelService NewWheel()
        => new(new TimerWheelConfig { TickDuration = TimeSpan.FromMilliseconds(8), WheelSize = 16 });
    ...
    public void RegisterRecurring_FiresAndRecordsSuccessMetadata()
    {
        ...
        jobs.RegisterRecurring("save", TimeSpan.FromMilliseconds(8), () => runs++, description: "world save");
