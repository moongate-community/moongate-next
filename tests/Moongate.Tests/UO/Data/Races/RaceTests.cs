...
public sealed class RaceTests
{
    ...
    {
        Assert.Equal(605, Race.Elf.AliveBody(female: false));
        Assert.Equal(606, Race.Elf.AliveBody(female: true));
        Assert.Equal(666, Race.Gargoyle.AliveBody(female: false));
        Assert.Equal(667, Race.Gargoyle.AliveBody(female: true));
    }
