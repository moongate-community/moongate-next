...
public sealed class AnimationIndexTests
{
    ...
    [Theory, InlineData(10, 0, 0, 1100), InlineData(10, 1, 2, 1107), InlineData(200, 0, 0, 22000),
     InlineData(201, 0, 1, 22066), InlineData(400, 0, 0, 35000), InlineData(401, 2, 3, 35188)]
    ...
    [Theory, InlineData(-1, 0, 0), InlineData(10, -1, 0), InlineData(10, 0, -1), InlineData(10, 0, 5)]
    ...
    [Theory, InlineData(10, 0, 0, 1, 1100), InlineData(400, 0, 0, 1, 35000), InlineData(100, 0, 0, 2, 11000),
     InlineData(250, 0, 0, 2, 25250), InlineData(100, 0, 0, 3, 11000), InlineData(350, 0, 0, 3, 36250),
     InlineData(400, 0, 0, 3, 35000), InlineData(250, 0, 0, 4, 25250), InlineData(400, 0, 0, 4, 35000),
     InlineData(100, 0, 0, 5, 11000), InlineData(250, 0, 0, 5, 25250)]
