...
public sealed class AnimationFrameDecoderTests
{
    ...
    {
        using var image = AnimationFrameDecoder.Decode(BuildBlock(), frame: 0);
    ...
    {
        Assert.Null(AnimationFrameDecoder.Decode(BuildBlock(), frame: 5));
    }
    ...
    public void Decode_ZeroSizeFrame_ReturnsNull()
    {
        ...
        w.Write(1);
        w.Write(8);
        w.Write((short)0); w.Write((short)0); w.Write((short)0); w.Write((short)0); // width=height=0
