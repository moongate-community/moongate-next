...
public static class MobileTemplatePaperdollEndpointExtensions
{
    ...
    internal static string GetCachePath(DirectoriesConfig directories, string id)
    {
        ...
        var directory = Path.Combine(directories[DirectoryType.Cache], "images", "paperdolls");
    ...
    internal static async Task<IResult> HandleGetPaperdollAsync(
        string id,
        IMobileTemplateService templates,
        IPaperdollRenderer renderer,
        DirectoriesConfig directories,
