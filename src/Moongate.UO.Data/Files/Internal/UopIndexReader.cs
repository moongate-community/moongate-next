...
public static class UopIndexReader
{
    ...
    public static Dictionary<int, UopEntry> ReadIndexes(
        FileStream stream,
        string fileExt,
    ...
    private static Dictionary<ulong, int> GenerateHashes(string filePath, string ext, int entryCount, int precision)
    {
